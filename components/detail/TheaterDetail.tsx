...
export function TheaterDetail({ data }: { data: ItemDetailData }) {
  ...
  return (
    <div className="pb-8">
      ...
      {/* Ticket CTA */}
      <div className="mx-6 mt-6 rounded-[12px] p-8 space-y-5" style={{ backgroundColor: "rgba(112,27,255,0.07)" }}>
        <p className="text-[16px] font-semibold leading-[150%]" style={{ color: "#13052B" }}>
