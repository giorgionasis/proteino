...
export function EventDetail({ data }: { data: ItemDetailData }) {
  ...
  return (
    <div className="pb-8">
      ...
      {/* Community */}
      <CommunitySection ratings={ratingDistribution} communityRating={avgRating} reviews={reviews} userRating={userRating} setUserRating={setUserRating} question="Με πόσα αστέρια θα βαθμολογούσες την εκδήλωση;" />
    </div>
  );
}
