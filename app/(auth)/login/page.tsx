  ...
  return (
    <div>
      ...
      <div className="px-5 mb-6">
        <h1 className="text-[26px] font-medium text-gray-900 leading-tight">Καλώς ήρθες,</h1>
        <p className="text-sm text-gray-500 mt-1">Χαιρόμαστε που σε βλέπουμε και πάλι!</p>
      </div>
