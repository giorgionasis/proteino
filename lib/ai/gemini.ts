...
- "location" = περιοχή/πόλη/νησί. Επέστρεψε null για: "κοντά μου", "κέντρο" χωρίς πόλη ("καφέ στο κέντρο" → null), "γύρω", "εδώ". ΜΟΝΟ συγκεκριμένα γεωγραφικά ονόματα (Αθήνα, Γλυφάδα, Μύκονος, Θεσσαλονίκη)
